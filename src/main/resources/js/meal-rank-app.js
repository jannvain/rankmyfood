...
var app = angular.module('mealRankApp', ['ngRoute',  'ngFileUpload', 'ngAnimate', 
    ...
    .controller('SettingsCtrl', ['$rootScope', '$scope' , '$routeParams', '$fancyModal', 'MealService', '$timeout', function ($rootScope, $scope, $routeParams, $fancyModal, MealService, $timeout) {
    ...
    }]).controller('MealNewCtrl', ['$rootScope', '$scope' , '$location', 'Upload', '$http', '$routeParams', 'MealService', 'NewUserService', '$timeout', '$fancyModal', function ($rootScope, $scope, $location, Upload, $http, $routeParams, MealService, NewUserService, $timeout, $fancyModal) {
